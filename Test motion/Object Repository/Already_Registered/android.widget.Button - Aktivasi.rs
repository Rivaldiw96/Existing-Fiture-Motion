...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Aktivasi</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Aktivasi' or . = 'Aktivasi') and @resource-id = 'com.mnc.mbanking.dev:id/btnSubmit']</locator>
